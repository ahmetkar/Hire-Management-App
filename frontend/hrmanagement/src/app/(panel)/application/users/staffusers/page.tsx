...
import { getAllUserAndStaff, StaffUserResponse } from '@/app/lists/datas/users';
...
const Page = () => {
    ...
    const [successDesc,setSuccessDesc] = useState("")
     ...
     const [staffusersResponse, setStaffUsersResponse] = useState<StaffUserResponse>({
        data: [],
        total: 0,
        page: 1,
        limit: defaultLimit,
            ...
            <div className="col-12">
              <div className="row">
                ...
                <div className="col-md-12 my-4">
                  <h2 className="h4 mb-1">Sisteme Kayıtlı/Görevli Personeller</h2>
                  <p className="mb-3"></p>
                    ...
                    <div className="card-body">
                      <div className="toolbar">
                        <form className="form">
                          ...
                          {(staffusersResponse.data != undefined ) ? (
                            <div>
                               <table className="table table-borderless table-hover">
                                ...
                                <tbody>
                                  ...
                                  {staffusersResponse.data.map((uap)=>(
                                  (uap != undefined) ? (
